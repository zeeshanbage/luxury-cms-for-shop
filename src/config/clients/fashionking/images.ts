export const imageConfig = {
  ...
  heroImages: {
    ...
    storefront: "/images/signboard.png",
  },
  ...
  testimonials: [
    { 
      ...
      clientImage: "/images/suit-client.png",
      reviewText: "The Jodhpuri suit fitting was absolutely flawless. They took the time to map my posture and the result was incredibly comfortable."
    },
  ]
};
