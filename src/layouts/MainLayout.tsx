...
export default function MainLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-luxury-black text-zinc-100 selection:bg-luxury-gold selection:text-black">
      ...
      <header className="relative w-full h-16 bg-[#030303] border-b border-white/5 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
          
          {/* Left: Navigation links */}
          <div className="flex items-center space-x-6 md:space-x-8 text-[10px] tracking-[0.25em] uppercase font-semibold font-sans">
          ...
          <div className="flex justify-end items-center">
            <Link
              to="/contact"
              className="relative px-4 sm:px-6 py-2 text-[10px] sm:text-xs tracking-widest uppercase border border-luxury-gold/40 text-luxury-gold hover:text-black font-sans font-medium transition-all duration-500 overflow-hidden group rounded-sm"
            >
