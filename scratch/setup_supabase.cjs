...
// Use service role key to bypass RLS for setup/upload
const supabaseKey = env.SERVICE_ROLE || env.VITE_SUPABASE_ANON_KEY;
...
async function run() {
  ...
  // Step B: Initialize Supabase Client with service key
